	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/new1" class="btn btn-success">Add new Appointment</a>
			</div>
			<br>
				...
				<tbody>
					...
					<c:forEach var="doctor" items="${listUser}">
						...
						<tr>
							...
							<td><a href="docAppointments?id=<c:out value='${doctor.doctorid}' />">historyofAppointmentts</a>
